	...
	<table cellpadding="4" cellspacing="4">
		<c:forEach var="contato" items="${lista}" varStatus="id">
			<tr bgcolor="#${id.count % 2 == 0 ? 'a87e14' : 'ffffff' }">
				...
				<td><a
					href="AtualizarContato.jsp?id=${contato.id}&nome=${contato.nome}&fone=${contato.fone}&nascimento=<fmt:formatDate value="${contato.nascimento.time}" pattern="dd/MM/yyyy"/>">atualizar</a>
				</td>
			</tr>
		</c:forEach>
